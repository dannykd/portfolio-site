        ...
        <main className="flex-grow">
          <div className="flex justify-end m-4 md:m-8 lg:m-16">
            <ul className="space-x-5 md:space-x-10 lg-space-x-20">
              <li className="inline"><a href="#" className=" underline font-semibold text-white text-xl md:text-2xl lg:text-4xl">/home</a></li>
              <li className="inline"><a href="#" className="hover:font-semibold text-white text-xl md:text-2xl lg:text-4xl">/projects</a></li>
              <li className="inline"><a href="#" className="hover:font-semibold text-white text-xl md:text-2xl lg:text-4xl">/interests</a></li>
            </ul>
          </div>
